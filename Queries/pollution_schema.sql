-- Creating tables for raw data (source EPA) on 
...
-- Table: 2016 Carbon Monoxide (co) for SF Bay Area
CREATE TABLE "2016-co-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2016 Nitrogen Dioxide (no2) for SF Bay Area
CREATE TABLE "2016-no2-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2016 Ozone (oz) for SF Bay Area
CREATE TABLE "2016-oz-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2016 Particulate Matter 2.5 (pm2.5) for SF Bay Area
CREATE TABLE "2016-pm2_5-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- view table
SELECT * FROM "2016-pm2_5-sfbay";

-- row count: 3392
SELECT 
   COUNT(*) 
FROM "2016-pm2_5-sfbay";


-- Table: 2016 Particulate Matter 10 (pm10) for SF Bay Area
CREATE TABLE "2016-pm10-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- view table
SELECT * FROM "2016-pm10-sfbay";

-- row count: 218
SELECT 
   COUNT(*) 
FROM "2016-pm10-sfbay";


-- Table: 2016 Sulfur Dioxide (so2) for SF Bay Area
CREATE TABLE "2016-so2-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2017 Carbon Monoxide (co) for SF Bay Area
CREATE TABLE "2017-co-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2017 Nitrogen Dioxide (no2) for SF Bay Area
CREATE TABLE "2017-no2-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2017 Ozone (oz) for SF Bay Area
CREATE TABLE "2017-oz-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- Table: 2017 Particulate Matter 2.5 (pm2.5) for SF Bay Area
CREATE TABLE "2017-pm2_5-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- view table
SELECT * FROM "2017-pm2_5-sfbay";

-- row count: 3695
SELECT 
   COUNT(*) 
FROM "2017-pm2_5-sfbay";


-- Table: 2017 Particulate Matter 10 (pm10) for SF Bay Area
CREATE TABLE "2017-pm10-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
...
-- view table
SELECT * FROM "2017-pm10-sfbay";

-- row count: 259
SELECT 
   COUNT(*) 
FROM "2017-pm10-sfbay";


-- Table: 2017 Sulfur Dioxide (so2) for SF Bay Area
CREATE TABLE "2017-so2-sfbay" (
     DATE_Year DATE NOT NULL,
     AQS_Source VARCHAR(365) NOT NULL,
	 Site_ID INT NOT NULL,
	 POC INT NOT Null,
